    ...
    <main class="flex-1 overflow-auto">
      ...
      <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Communities Management</h2>
                    ...
                    <div class="flex items-center">
                      ...
                      <div class="ml-4">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                          Piano enthusiasts community
                        </div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span class="text-sm text-gray-900 dark:text-white">1,234</span>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
